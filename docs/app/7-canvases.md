...
With your backlog tracked, you can build a hosted AI agent from the Tailspin catalog or take a step back to review everything you've built. Continue to [Optional - Build a Backer Concierge with the Microsoft Foundry Canvas][next-lesson].
